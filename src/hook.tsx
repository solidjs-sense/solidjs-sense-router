...
const navigate = (params: UrlParams) => {
  ...
  !params.replace
    ? api.pushState(params.state, displayUrl)
    : api.replaceState(params.state, displayUrl)
